 ...
 */
package co.com.ceiba.edu.drools.jbpm;
...
public class DynamicReusableSubProcessTest {
    ...
    public void reusableProcessTest(){
        ...
        ProcessInstance process = ksession.startProcess("co.com.ceiba.edu.drools.jbpm.dynamicreusablesubprocessparent",parameters);
        ...
        //Start the process using its id
        process = ksession.startProcess("co.com.ceiba.edu.drools.jbpm.dynamicreusablesubprocessparent",parameters);
    ...
    public StatefulKnowledgeSession createKSession(){
        ...
        kbuilder.add(new ClassPathResource("subProcessSelectionRules.drl", getClass()), ResourceType.DRL);
        kbuilder.add(new ClassPathResource("dynamicReusableSubProcess-Parent.bpmn", getClass()), ResourceType.BPMN2);
        kbuilder.add(new ClassPathResource("personTaggerProcess.bpmn", getClass()), ResourceType.BPMN2);
        kbuilder.add(new ClassPathResource("carTaggerProcess.bpmn", getClass()), ResourceType.BPMN2);
