...
public class RulesExecutionLoggingTest {
    ...
    public void simpleTest() {
        ...
        FactType serverType = kbase.getFactType("co.com.ceiba.edu.drools.logging", "Server");
        ...
        try {
            ...
            System.err.println("the class Server on  package hasn't a constructor");
        } catch (IllegalAccessException e) {
            System.err.println("unable to access the class Server on  package");
        }
